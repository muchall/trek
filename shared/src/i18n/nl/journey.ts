...
const journey: TranslationStrings = {
  ...
  // Gastenboek — reacties + likes van geverifieerde bezoekers, plus moderatie.
  'journey.guestbook.settingsTitle': 'Gastenboek',
  'journey.guestbook.commentsEnabled': 'Reacties toestaan',
  'journey.guestbook.commentsEnabledHint': 'Bezoekers met een geverifieerd e-mailadres kunnen reageren en liken.',
  'journey.guestbook.displayName': 'Je naam bij reacties',
  'journey.guestbook.displayNamePlaceholder': 'bijv. Milan',
  'journey.guestbook.displayNameHint': 'Wordt getoond bij de reacties die je plaatst. Standaard je gebruikersnaam.',
  'journey.guestbook.save': 'Opslaan',
  'journey.guestbook.saved': 'Opgeslagen',
  'journey.guestbook.comment': 'Reageren',
  'journey.guestbook.commentsCount': '{count} reacties',
  'journey.guestbook.beFirst': 'Wees de eerste die een reactie plaatst.',
  'journey.guestbook.closed': 'Reacties zijn gesloten voor deze reis.',
  'journey.guestbook.commentAs': 'Reageer als {name}…',
  'journey.guestbook.post': 'Plaatsen',
  'journey.guestbook.linkSent': 'Check je e-mail — we hebben je een link gestuurd om te bevestigen en te reageren.',
  'journey.guestbook.leaveComment': 'Laat een reactie achter — bevestig eenmalig je e-mailadres.',
  'journey.guestbook.yourName': 'Je naam',
  'journey.guestbook.emailPlaceholder': 'jij@voorbeeld.nl',
  'journey.guestbook.sendLink': 'Stuur mij de link',
  'journey.guestbook.enterNameEmail': 'Vul je naam en een geldig e-mailadres in.',
  'journey.guestbook.postError': 'Je reactie kon niet worden geplaatst. Probeer het opnieuw.',
  'journey.guestbook.linkError': 'De link kon niet worden verstuurd. Probeer het opnieuw.',
  'journey.guestbook.verifyToLike': 'Bevestig je e-mailadres om te liken',
  'journey.guestbook.author': 'Auteur',
  'journey.guestbook.you': 'Jij',
  'journey.guestbook.reply': 'Antwoorden',
  'journey.guestbook.replyPlaceholder': 'Antwoord…',
  'journey.guestbook.send': 'Versturen',
  'journey.guestbook.deleteComment': 'Reactie verwijderen',
  'journey.guestbook.deleteReply': 'Antwoord verwijderen',
  'journey.guestbook.guestCommentsCount': 'Reacties van gasten · {count}',
};
