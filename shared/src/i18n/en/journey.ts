...
const journey: TranslationStrings = {
  ...
  // Guestbook — comments + likes from verified visitors, and owner moderation.
  'journey.guestbook.settingsTitle': 'Guestbook',
  'journey.guestbook.commentsEnabled': 'Allow comments',
  'journey.guestbook.commentsEnabledHint': 'Visitors with a verified email can comment and like.',
  'journey.guestbook.displayName': 'Your name on replies',
  'journey.guestbook.displayNamePlaceholder': 'e.g. Milan',
  'journey.guestbook.displayNameHint': 'Shown on the comments and replies you post. Defaults to your username.',
  'journey.guestbook.save': 'Save',
  'journey.guestbook.saved': 'Saved',
  'journey.guestbook.comment': 'Comment',
  'journey.guestbook.commentsCount': '{count} comments',
  'journey.guestbook.beFirst': 'Be the first to leave a comment.',
  'journey.guestbook.closed': 'Comments are closed for this journey.',
  'journey.guestbook.commentAs': 'Comment as {name}…',
  'journey.guestbook.post': 'Post',
  'journey.guestbook.linkSent': 'Check your email — we sent you a link to confirm and start commenting.',
  'journey.guestbook.leaveComment': 'Leave a comment — confirm your email once.',
  'journey.guestbook.yourName': 'Your name',
  'journey.guestbook.emailPlaceholder': 'you@example.com',
  'journey.guestbook.sendLink': 'Send me the link',
  'journey.guestbook.enterNameEmail': 'Enter your name and a valid email.',
  'journey.guestbook.postError': 'Could not post your comment. Please try again.',
  'journey.guestbook.linkError': 'Could not send the link. Please try again.',
  'journey.guestbook.verifyToLike': 'Verify your email to like',
  'journey.guestbook.author': 'Author',
  'journey.guestbook.you': 'You',
  'journey.guestbook.reply': 'Reply',
  'journey.guestbook.replyPlaceholder': 'Reply…',
  'journey.guestbook.send': 'Send',
  'journey.guestbook.deleteComment': 'Delete comment',
  'journey.guestbook.deleteReply': 'Delete reply',
  'journey.guestbook.guestCommentsCount': 'Guest comments · {count}',
};
